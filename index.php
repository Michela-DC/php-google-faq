...
$faq = [
    [
        'question' => '<h3 class="question">Come state implementando la recente decisione della Corte di giustizia dell\'Unione europea (CGUE) relativa al diritto all\'oblio?</h3>',
    ...
    [
        'question' => '<h3 class="question">Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h3>',
    ...
    [
        'question' => '<h3 class="question">Perché il mio account è associato a un paese?</h3>',
    ...
    [
        'question' => '<h3 class="question">Stabilire il paese associato al tuo account</h3>',
